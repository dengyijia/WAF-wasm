...
type TestSuite struct {
  ...
  // a collection of tests to run in this suite
...
/*
* Test struct
*   keep track of info used by one test in a test suite
*/
type Test struct {
...
*/
func (t TestSuite) RunTest(test_name string, test Test) {
  result := t.Eval(test)
  if !result {
...
*/
func (suite TestSuite) Eval(test Test) bool {
  // initialize request
